...
MAC (Raghav): SITL env live (launch: ../ardupilot/Tools/autotest/sim_vehicle.py -v ArduCopter -f hexa --no-mavproxy --speedup 5 --add-param-file=uno_q/sitl_rangefinder.parm; PATH-prefix repo .venv/bin). uno_q/sitl_test.py PASS both scenarios 2026-07-26. AWAITING RAGHAV: fill UNO_Q_SSH + SSH_KEY in Mac PRIVATE.md (no keypair on Mac yet) before any board work from Mac.
