...
# ENV-MAC (2026-07-26): 2nd dev machine = Raghav's Mac (darwin), repo /Users/raghav/Desktop/ai_projects/monsoonready-drone, git identity Raghav Raj, push auth works. PRIVATE.md copied from sample, values UNFILLED (min for board work from Mac: UNO_Q_SSH, SSH_KEY). NO TRAINING on Mac (Raghav 2026-07-26): all training on Reyansh's device = the RTX3050 Zorin laptop above (ASSUMPTION: Zorin/"sleuther" operator = Reyansh; correct here if wrong). Mac side owns software-parallel TODO items unless told otherwise.
