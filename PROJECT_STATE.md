...
# ENV: user OS=Zorin OS 18 (Linux). GCS=QGroundControl ONLY (AppImage at /media/sleuther/Stuff/). NOT Mission Planner. Laptop GPU=RTX3050 4GB. Project root=/media/sleuther/Stuff/Robu AI Challenge (moved 2026-07-25 from OneDrive; is a git repo now).
